...
public class PiercingBloodEntity extends BeamEntity {
    public PiercingBloodEntity(EntityType<? extends Projectile> pType, Level pLevel) {
        super(pType, pLevel);
    }

    public PiercingBloodEntity(LivingEntity owner, float power) {
        super(JJKEntities.PIERCING_BLOOD.get(), owner, power);
    }
    ...
    protected @Nullable Ability getSource() {
        return JJKAbilities.PIERCING_BLOOD.get();
    }
